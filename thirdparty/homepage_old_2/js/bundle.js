...
function prepareReddit(container, json)
{
    ...
    //Dirty stuff
    $(".reddit-item .bullet:not(:empty)").css({display : "table-cell", width: "150px"});
}
